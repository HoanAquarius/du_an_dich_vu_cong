...
$mockDigitalWallet = [
    ...
    "requester_gender" => "Nam", // Đã bổ sung trường giới tính
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $thu_tuc = "Đăng ký cư trú";
    $target_time_mysql = date('Y-m-d H:i:s', strtotime('+7 days')); // Cư trú thường xử lý lâu hơn (7 ngày)
    ...
    try {
        ...
        $realtimeData = [
            ...
            "target_time" => date('Y-m-d\TH:i:s', strtotime('+7 days'))
        ];
...
<head>
    ...
    <title>Đăng ký cư trú - Cổng dịch vụ công quốc gia</title>
...
<body class="bg-[#f8fafc] text-gray-800 h-screen flex flex-col overflow-hidden">
    ...
    <div class="flex flex-1 overflow-hidden">
        ...
        <main class="flex-[6] min-w-0 bg-white border-r p-4 lg:p-6 overflow-y-auto">
            <div class="text-xs text-gray-500 mb-4 flex items-center gap-2">
                ...
                <span class="text-gray-800">Đăng ký cư trú</span>
            </div>
 
            <h1 class="text-2xl font-bold mb-1">Đăng ký cư trú (Thường trú / Tạm trú)</h1>
            <p class="text-sm text-gray-500 mb-4">Công an Phường Tân An, TP. Buôn Ma Thuột</p>
                ...
                <div class="bg-gray-200 p-2 md:p-4 rounded-xl border border-gray-300 mb-8 shadow-inner overflow-x-auto">
                    <div class="w-full max-w-[850px] min-w-[500px] mx-auto bg-white p-6 md:p-10 shadow-xl text-black text-[14px] md:text-[15px] leading-relaxed" style="font-family: 'Times New Roman', Times, serif;">
                        ...
                        <div class="text-center mb-8">
                            ...
                            <h1 class="font-bold text-xl md:text-2xl uppercase mt-8 mb-6">Tờ khai thay đổi thông tin cư trú</h1>
                            <p class="italic text-sm">(Mẫu CT01 ban hành kèm theo Thông tư số 56/2021/TT-BCA)</p>
                        </div>
 
                        <div class="space-y-4 mt-6">
                            <div class="flex items-end gap-2 ml-8 md:ml-16">
                                <span class="whitespace-nowrap">Kính gửi: <sup>(1)</sup></span>
                                <input type="text" id="kinh_gui" name="kinh_gui" class="flex-1 min-w-[50px] border-b-[1.5px] border-dotted border-black bg-transparent focus:outline-none focus:border-blue-600 px-1" placeholder="VD: Công an Phường Tân An, TP. Buôn Ma Thuột">
                            </div>
                            ...
                            <div class="flex items-end gap-2 mt-1">
                                <span class="whitespace-nowrap">4. Số định danh cá nhân/CMND:</span>
                                <input type="text" id="req_id_number" name="req_id_number" class="flex-1 min-w-[50px] border-b-[1.5px] border-dotted border-black bg-transparent focus:outline-none focus:border-blue-600 px-1" placeholder="Nhập số CCCD/CMND 12 số">
                            </div>

                            <div class="flex flex-wrap md:flex-nowrap items-end gap-2 mt-1">
                                <span class="whitespace-nowrap">5. Số điện thoại liên hệ:</span>
                                ...
                                <span class="whitespace-nowrap">6. Email:</span>
                                <input type="email" id="req_email" name="req_email" class="flex-1 min-w-[80px] border-b-[1.5px] border-dotted border-black bg-transparent focus:outline-none focus:border-blue-600 px-1">
                            </div>
                             
                            <div class="flex flex-col gap-2 mt-1">
                                <div class="flex items-end gap-2">
                                    <span class="whitespace-nowrap">7. Nơi thường trú:</span>
                            ...
                            <div class="flex flex-col gap-2 mt-1">
                                <div class="flex items-end gap-2">
                                    <span class="whitespace-nowrap">8. Nơi tạm trú:</span>
                                    <input type="text" id="req_tam_tru_line1" name="req_tam_tru_line1" maxlength="70" class="flex-1 min-w-[50px] border-b-[1.5px] border-dotted border-black bg-transparent focus:outline-none focus:border-blue-600 px-1" placeholder="Nhập nơi tạm trú (nếu có)...">
                                </div>
                                <input type="text" id="req_tam_tru_line2" name="req_tam_tru_line2" class="w-full border-b-[1.5px] border-dotted border-black bg-transparent focus:outline-none focus:border-blue-600 px-1">
                            </div>

                            <div class="flex flex-col gap-2 mt-1">
                                <div class="flex items-end gap-2">
                                    <span class="whitespace-nowrap">9. Nơi ở hiện tại:</span>
                                    <input type="text" id="req_hien_tai_line1" name="req_hien_tai_line1" maxlength="65" class="flex-1 min-w-[50px] border-b-[1.5px] border-dotted border-black bg-transparent focus:outline-none focus:border-blue-600 px-1" placeholder="Nhập địa chỉ nơi ở hiện tại...">
                                </div>
                            ...
                            <div class="flex flex-col gap-2 mt-1">
                                <div class="flex items-end gap-2">
                                    <span class="whitespace-nowrap font-bold">10. Nội dung đề nghị: <sup>(2)</sup></span>
                                    <input type="text" id="noi_dung_de_nghi_line1" name="noi_dung_de_nghi_line1" maxlength="50" class="flex-1 min-w-[50px] border-b-[1.5px] border-dotted border-black bg-transparent focus:outline-none focus:border-blue-600 px-1 font-bold" placeholder="VD: Đăng ký thường trú / Đăng ký tạm trú...">
                                </div>
            ...
            <div class="text-xs text-gray-500 flex items-center gap-1 font-sans">
                <i class="fa-solid fa-lock text-[10px]"></i> Căn cứ theo Luật Cư trú 2020. Dữ liệu được xác thực trực tiếp qua CSDL Quốc gia về dân cư.
            </div>
        </main>
        ...
        <aside class="flex-[3.3] min-w-[320px] bg-white flex flex-col shrink-0">
            ...
            <div class="flex-1 overflow-y-auto p-4 bg-gray-50/50">
                <p class="text-sm text-gray-600 mb-4">Dựa trên thủ tục "Đăng ký cư trú" và tài khoản của bạn, hồ sơ cần chuẩn bị bao gồm:</p>
                    ...
                    <table class="w-full text-sm text-left">
                        ...
                        <tbody class="divide-y text-gray-700 text-xs">
                            <tr>
                                ...
                                <td class="px-4 py-3">Tờ khai thay đổi thông tin cư trú (CT01)</td>
                            ...
                            <tr>
                                ...
                                <td class="px-4 py-3">Giấy tờ, tài liệu chứng minh chỗ ở hợp pháp (Sổ đỏ, Hợp đồng thuê nhà...)</td>
                                <td class="px-4 py-3 text-green-600"><i class="fa-solid fa-check mr-1"></i>Bắt buộc</td>
                                <td class="px-4 py-3 text-red-500"><i class="fa-regular fa-circle-xmark mr-1"></i>Chưa đính kèm</td>
                            </tr>
                            <tr>
                                <td class="px-4 py-3 text-center">3</td>
                                <td class="px-4 py-3">Giấy tờ chứng minh quan hệ nhân thân</td>
                                <td class="px-4 py-3 text-gray-400">—</td>
                                <td class="px-4 py-3 text-gray-400">Nếu đăng ký theo người thân</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <ul class="text-xs text-gray-600 space-y-2 mb-3">
                        <li class="flex items-center"><span class="mr-2 text-sm">⏱</span>Thời gian giải quyết: Tối đa 07 ngày làm việc</li>
                        <li class="flex items-center"><span class="mr-2 text-sm">💰</span>Lệ phí: 10,000 VNĐ - 20,000 VNĐ (tùy khu vực)</li>
                        <li class="flex items-center"><span class="mr-2 text-sm">📍</span>Cơ quan tiếp nhận: Công an cấp xã/phường</li>
                        <li class="flex items-center"><span class="mr-2 text-sm">👤</span>Đối tượng thực hiện: Công dân Việt Nam</li>
                    </ul>
                ...
                <div class="mb-4">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <span class="bg-gray-100 hover:bg-gray-200 cursor-pointer text-gray-700 text-xs px-3 py-1.5 rounded-full">Thuê nhà có được đăng ký thường trú?</span>
                        <span class="bg-gray-100 hover:bg-gray-200 cursor-pointer text-gray-700 text-xs px-3 py-1.5 rounded-full">Chủ nhà không cho mượn sổ đỏ thì sao?</span>
                        <span class="bg-gray-100 hover:bg-gray-200 cursor-pointer text-gray-700 text-xs px-3 py-1.5 rounded-full">Tạm trú bao lâu thì bị xóa?</span>
                        <span class="bg-gray-100 hover:bg-gray-200 cursor-pointer text-gray-700 text-xs px-3 py-1.5 rounded-full">Phân biệt Thường trú và Tạm trú?</span>
                    </div>
                </div>
            </div>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        // Áp dụng auto-jump cho form CT01
        setupAutoJump('req_thuong_tru_line1', 'req_thuong_tru_line2', 64);
        setupAutoJump('req_tam_tru_line1', 'req_tam_tru_line2', 69);
        ...
        if (walletData) {
            ...
            if (walletData.requester_address) {
                ...
                if (addressParts.length >= 3) {
                    ...
                    // Cơ quan thụ lý cư trú là Công an (không phải UBND)
                    kinhGuiValue = "Công an " + phuongXa + ", " + quanHuyen;
                }
            }
            ...
            const fillMap = {
                ...
                'req_gender': walletData.requester_gender, // Tự động điền giới tính
                'req_id_number': walletData.requester_id_number,
                'req_phone': walletData.phone_number,
                
                // Điền nơi thường trú theo CSDL hiện tại. Bỏ trống nơi ở hiện tại để người dùng tự nhập.
        ...
        // Logic Gửi thông báo WebSocket (Giữ nguyên)
